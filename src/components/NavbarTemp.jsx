  ...
  <nav className="bg-gray-800 border-gray-200 dark:text-white">
    <div className="max-w-screen-xl flex items-center justify-between mx-auto p-6">
      ...
      <div className="hidden md:flex md:items-center md:space-x-8">
        ...
        <a href="/admission" className="text-white hover:text-gray-400">Admission</a>
        <a href="/Subjects" className="text-white hover:text-gray-400">Courses</a>
        <a href="/login" className="text-white hover:text-gray-400">Sign In</a>
      </div>
    </div>
