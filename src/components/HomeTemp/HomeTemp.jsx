...
const HomeTemp = () => {
  return (
    <div
      className='relative bg-cover bg-center h-screen border-b '
      style={{
        backgroundImage:
          "url('https://cache.careers360.mobi/media/article_images/2021/12/30/FHwW1UHVUAEGehz_1.jpg')"
      }}
    >
      ...
      <div className='relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4'>
        ...
        <p className='text-xl mb-8 max-w-2xl'>
          Join us at Educare Institute of Education <br /> for a transformative
          learning experience.
        </p>
        <div>
          {/* <Dropdown /> */}
          <a
            href='/gia'
            className='bg-transparent border border-white hover:bg-white hover:text-blue-600 text-white font-semibold py-3 px-6 rounded-lg m-2'
          >
